...
$location = $_SESSION['location'];
	...
	$p_id=$_SESSION['p_id'];
     $result=mysqli_query($conn,"SELECT c_id,type_crime,d_o_c,location,c_place,lat,lon FROM complaint where p_id='$p_id' and pol_status='In Process' and location='$location' order by c_id desc");
    ?>
 <script>
     function f1()
        {
  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<li ><a href="fir.php">FIR MAINTAINCE</a></li>
 ...
 <div style="padding:50px;">
   <table class="table table-bordered">
    <thead class="thead-dark" style="background-color: black; color: white;">
	  ...
	  <th scope="col">track location</th>
      </tr>
    </thead>
...
<?php
    ...
    <tbody style="background-color: white; color: black;">
      <tr>
		...
		<td><?php echo $rows['c_place']; ?></td> 
		<td><a href="google-map.php?lat=<?php echo $lat?>&lon=<?php echo $lon?>">TRACK loaction</a></td> 
