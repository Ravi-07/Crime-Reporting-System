...
<head>
    ...
    $query="select c_id,type_crime,d_o_c,location,c_place,lat,lon,inc_status,p_id from complaint where location='$location' order by c_id desc";
...
<body style="background-color: #dfdfdf">
 ...
 <div style="padding:50px;">
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b> All Right Reserved</b></h4>
</div>
