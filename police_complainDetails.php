...
<head>
    ...
    if(isset($_POST['close'])){
     ...
     $res2=mysqli_query($conn,"select uc.d_o_u,uc.case_update,c.u_id from update_case uc,complaint c where uc.c_id=c.c_id and c.c_id='$cid'");
   ...
   <table class="table table-bordered">
    ...
    <tr>
      ...
      <td><?php echo $rows1['case_update']; ?></td>
        <?php
		$to_email=$rows1['u_id'];
		$subject="Complaint update Status";
		$body="Date of Update: ". $rows1['d_o_u'] . " "."Case Update: ". $rows1['case_update']." ";
		$headers="From: arashanagi07@gmail.com";
