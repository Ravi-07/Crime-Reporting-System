...
session_start();
    ...
    $u_id=$_SESSION['u_id'];
        ...
        $result=mysqli_query($conn,"SELECT u_name,u_id,a_no FROM user where u_id='$u_id' ");
        while($q2=mysqli_fetch_assoc($result)){
        $a_no=$q2['a_no'];
        $u_name=$q2['u_name'];
		}
...
if(isset($_POST['s'])){
    ...
    if($var>=0)
    {
      ...
      $comp="INSERT into complaint(u_id,a_no,location,c_place,lat,lon,type_crime,d_o_c,description) values('$u_id','$a_no','$location','$c_place','$lat','$lon','$type_crime','$d_o_c','$description')";
	...
	<div class="center-container">
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				Email-Id<input type="email"  name="email"  required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" id="email1" value="<?php echo $u_id; ?>">
				Aadhar
				...
				place(<a href="https://www.latlong.net/">click here to locate</a>)
				<input type="text" name="c_place" placeholder="Enter address">
				latitude <input type="text" name="lat" placeholder="Enter latitude">
				 longitude<input type="text" name="lon" placeholder="Enter longitude">
