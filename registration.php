		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<p style="color:#dfdfdf">Email-Id<input type="email"  name="email"  required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"   id="email1" onfocusout="f1()"/>
                    <p style="color:#dfdfdf">Password</p><input type="password"  name="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number,one uppercase & lowercase letter,and at least 6 or more characters" id="pass" onfocusout="f1()"/><input type="checkbox" onclick="myFunction()">Show Password
